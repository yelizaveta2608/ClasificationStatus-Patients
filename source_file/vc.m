...
%      applied to the GUI before vc_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 24-Jan-2019 21:26:27
...
global riven ax1;
riven=str2num(get(hObject,'string'))
if 3.3<riven && riven<5.6
    ax1=0;
elseif riven>6.1
    ax1=19.4;
end
...
global shvydk ax2;
shvydk=str2num(get(hObject,'string'))
if shvydk==0
    ax2=0;
elseif shvydk==1
    ax2=12.7;
...
global creatynin ax3;
creatynin=str2num(get(hObject,'string'))
if creatynin<=1
    ax3=0;
elseif creatynin>1
    ax3=16.2;
...
global vozrast ax4;
vozrast=str2num(get(hObject,'string'))
if vozrast<40
    ax4=0;
elseif vozrast>=40
    ax4=8;
...
global vaha ax5 ax1 ax2 ax3 ax4 rhnV kne osV;
vaha=str2num(get(hObject,'string'))
if vaha<80
    ax5=0;
elseif vaha>=80
    ax5=6.5;
...
%Ризик розвитку хронічної недостатності
rhnV=ax1+ax2+ax3+ax4+ax5
if  rhnV<10
    kne='норма';
    osV=1;
elseif  10<rhnV  && rhnV<25
    kne='ступень 1';
    osV=0.75;
elseif 25<rhnV && rhnV<50
    kne='ступень 2';
    osV=0.25;
elseif 50<rhnV
    kne='ступень 3';
    ...
    kne='помилка (перевірте введені дані)';
end
